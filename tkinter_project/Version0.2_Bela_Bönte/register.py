...
class RegisterPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #CHECK PASSWORDS AND IF ALL FIELDS ARE FILLED OUT 
    ...
    def checkFilled(self):
        ...
        # CHECKS THE USERS INPUT AND SAVE NEW USER WITH DAO LAYER TO DATABASE
    def registerUser(self):
        ...
        # OUTSOURCED FUNCTION ! WORKS WITH OBJECT USER PASSED INTO FUNCTION
